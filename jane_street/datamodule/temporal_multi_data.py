...
from ..datasets import JSDatasetMeta, custom_collate_fn
from ..datasets.js_ts_multidataset import JSTSMultiDataset
from ..samplers import JSPredictDataSampler
from ..samplers.train_sampler_uni import JSTrainDataSampler


class JSMultiDataModule(pl.LightningDataModule):
    def __init__(self, config: DictConfig):
        super(JSMultiDataModule, self).__init__()
        self.config = config
    ...
    def setup(self, stage: Optional[str] = None):
        if stage == "fit":
            ...
            self.train_dataset = JSTSMultiDataset(
            ...
            self.val_dataset = JSTSMultiDataset(
        ...
        if stage == "test":
            ...
            self.test_dataset = JSTSMultiDataset(self.test_dataset_metadata)
