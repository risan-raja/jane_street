...
from ..samplers.tsmixer_sampler import JSMixerTrainDataSampler, JSMixerValDataSampler


class JSTSMixerDataModule(pl.LightningDataModule):
    def __init__(self, config: DictConfig):
        super(JSTSMixerDataModule, self).__init__()
        self.config = config
        ...
        self.lookback_without_sampling = config.lookback_without_sampling
    ...
    def train_dataloader(self):
        ...
        self.train_sampler = JSMixerTrainDataSampler(
            self.train_dataset,
    ...
    def val_dataloader(self):
        ...
        self.val_sampler = JSMixerValDataSampler(
    ...
    def test_dataloader(self):
        ...
        self.test_sampler = JSMixerValDataSampler(
